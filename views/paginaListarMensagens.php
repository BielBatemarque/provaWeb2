	...
	<div class="table-responsive" id="listagem">
		<table class="table table-striped">
			...
			<tr>
				...
				<?php 
				if($contato->getResposta()->getDescricao() != null){?>
					<td><a href=../controller/deletarMensagem.php?id=<?=$contato->getCodigo()?>>Remov. Resposta</a></td>
				<?php }else{?>
					<td><a href=paginaRespoder.php?id=<?=$contato->getCodigo()?>>Responder</a></td>
				<?php }?>
